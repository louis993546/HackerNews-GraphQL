...
func (ec *executionContext) _Query_story(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	return ec.marshalNStory2ᚖgithubᚗcomᚋlouistsaitszhoᚋhnᚑgqlᚐStory(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNStory2githubᚗcomᚋlouistsaitszhoᚋhnᚑgqlᚐStory(ctx context.Context, sel ast.SelectionSet, v Story) graphql.Marshaler {
	return ec._Story(ctx, sel, &v)
}

func (ec *executionContext) marshalNStory2ᚖgithubᚗcomᚋlouistsaitszhoᚋhnᚑgqlᚐStory(ctx context.Context, sel ast.SelectionSet, v *Story) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
